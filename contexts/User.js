  ...
  return (
    <UserContext.Provider
      value={useMemo(
        () => [
          state,
          { updateTransactions, updatePositions, updateMiningPositions, updateUserSnapshots, updateUserPairReturns,updateTab },
        ],
        [state, updateTransactions, updatePositions, updateMiningPositions, updateUserSnapshots, updateUserPairReturns, updateTab]
      )}
    >
      {children}
    </UserContext.Provider>
...
export function updateRouter() {
  const [state,{updateTab}] = useUserContext();

...
const colorStyle2 = {backgroundImage: "linear-gradient( to right,#f92772 0%,#d90752 100% )" };
...
function TokenCard(props){
    const {output, name, symbol, price, priceChange, volume, volumeChange, liquidity, liquidityChange} =props;
        ...
        <div className = "x-pair-card1">
            <div>
                ...
                <span className = "float-right">
                    <Link color="textDim" external href={'https://app.uniswap.org/#/swap?outputCurrency=' + output}>
                        <button className = "x-button3" style = {colorStyle2}>Trade</button>
                    </Link>
                </span>
            ...
            <div className = "mt-5">
                <div className = "mb-2">
                    <span className = "x-font1">Name:</span>
                    <span className = "x-font1 float-right">{name}</span>
                </div>
                <div className = "mb-2">
                    <span className = "x-font1">Symbol:</span>
                    <span className = "x-font1 float-right">{symbol}</span>
                </div>
                <div className = "mb-2">
                    <span className = "x-font1">Price:</span>
                    <span className = "x-font1 float-right">{price}</span>
                </div>
                <div className = "mb-2">
                    <span className = "x-font1">Volume:</span>
                    <span className = "x-font1 float-right">{volume}</span>
                </div>
                <div className = "mb-2">
                    <span className = "x-font1">Liquidity:</span>
                    <span className = "x-font1 float-right">{liquidity}</span>
                </div>
            </div>
            <div className = "mt-3 text-right"><button className = "x-button4" style = {colorStyle2}>View market cap</button></div>
